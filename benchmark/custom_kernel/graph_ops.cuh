#ifndef __CUSTOM_OPS_H_
#define __CUSTOM_OPS_H_
...
__global__ void maskedmm_csr_forward_kernel(const idx_t* __restrict__ indptr, const idx_t* __restrict__ indices, const data_t* __restrict__ A, const data_t* __restrict__ B, data_t* __restrict__ y, const int d, const int n, const int h) {
    int i = blockIdx.x; 
    int tx = threadIdx.x;
 ...
 */
template <typename idx_t, typename data_t>
__global__ void sparse_softmax_forward_kernel(const idx_t* __restrict__ indptr, const data_t* __restrict__ x, data_t* __restrict__ y, const int n, const int h) {
    //data_t max_val = -1e9;
