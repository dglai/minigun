...
# Usage:
#   minigun_detect_installed_gpus(out_variable)
function(minigun_detect_installed_gpus out_variable)
...
# Usage:
#   minigun_select_nvcc_arch_flags(out_variable)
function(minigun_select_nvcc_arch_flags out_variable)
  # List of arch names
  ...
  elseif(${CUDA_ARCH_NAME} STREQUAL "Auto")
    minigun_detect_installed_gpus(__cuda_arch_bin)
...
# Usage:
#   minigun_cuda_compile(<objlist_variable> <cuda_files>)
macro(minigun_cuda_compile objlist_variable)
...
if(USE_CUDA)
  ...
  add_definitions(-DMINIGUN_USE_CUDA)

  file(GLOB_RECURSE MINIGUN_CUDA_SRC "minigun/minigun/cuda/*.cuh")
  list(APPEND MINIGUN_SRC ${MINIGUN_CUDA_SRC})
  ...
  set(CUDA_NVCC_FLAGS "--expt-extended-lambda ${CUDA_NVCC_FLAGS}")
